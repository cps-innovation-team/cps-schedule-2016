...
#MARK
readPath = "/Users/msa/Desktop/CPS.ics"
writePath = "/Users/msa/Desktop/Newest.txt"
...
def main():
    ...
    with open(readPath) as f:
        ...
        for vevent in vevents:
            ...
            if vevent.summary == "Lunch":
                vevent.summary = "Lunch (M1)"
            if vevent.summary == "Morning Breaklet":
                vevent.summary = "Breaklet (M1)"
            if vevent.summary == "Afternoon Breaklet":
                vevent.summary = "Breaklet (M1)"
            if vevent.summary == "Freshman CAP":
                continue
            if vevent.summary == "Advising":
                vevent.summary == "Advising (M1)"
            if vevent.summary == "Collab/Community":
                vevent.summary = "Collab/Community (M1)"
            #END CORONA NEW#
